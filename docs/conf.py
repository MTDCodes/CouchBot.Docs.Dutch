...
# -*- coding: utf-8 -*-
#
# CouchBot documentation build configuration file, created by
# sphinx-quickstart on Mon Aug 19 23:18:25 2019.
#
...
html_logo = "_static/CouchBot.png"
...
html_context = {
    ...
    "display_gitlab": True,
    "gitlab_user": "MattTheDev",
    "gitlab_repo": "CouchBot",
    "gitlab_version": "/tree/master/docs/",
}
...
latex_documents = [
    (master_doc, "CouchBot.tex", "CouchBot Documentation", "Matt Smith", "manual")
]
...
man_pages = [(master_doc, "CouchBot", "CouchBot Documentation", [author], 1)]
